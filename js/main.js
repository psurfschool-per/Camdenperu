...
if(_tel.length===11 && _tel.indexOf('51')===0) _tel=_tel.slice(2);
if(!/^9\d{8}$/.test(_tel)){alert('Revisa tu WhatsApp: escribe los 9 dígitos sin +51 (ej. 979 359 261).');return;}
